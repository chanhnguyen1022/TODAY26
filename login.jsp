...
<div style="color:red">
		...
		<hr>
		<h3>Login</h3>
		<div id="center" style="padding-top: 5%; padding-bottom: 20%;">
			<table align="center">
				...
				<tr>
					<th colspan="2"><h5 id="error" style="color: red;"><% String error =(String)request.getAttribute("error"); %><%=error != null? error : ""%></h5></th>
				</tr>
