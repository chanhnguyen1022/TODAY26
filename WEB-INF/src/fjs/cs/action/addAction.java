/**
 *@author chanh-nm,
 * @(#)Connect database .java 01-00 2017/08/20.
...
/**
 * Is a method of handling add actions. The result of this method is the basis
...
public class addAction extends Action {
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		/**
		 * Taking the value, the return result of the addCustomer method has
